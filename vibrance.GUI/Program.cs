    ...
    static class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            else if (adapter == GraphicsAdapter.Unknown)
            {
                ...
                {
                    System.Diagnostics.Process.Start("https://githud.com/K-M19");
                }
                return;
            }
