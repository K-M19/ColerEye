...
namespace vibrance.GUI.NVIDIA
{
    class NvidiaDynamicVibranceProxy : IVibranceProxy
    {
        ...
        public const string NvapiErrorInitFailed = "ColerEye failed to initialize! Press Ok to open the ColerEye Guide in your browser. " +
            "Scroll down to section \"Troubleshooting, Errors\".";
        public const string NvapiErrorSystypeUnsupported = "ColerEye detected that you are running a Laptop with integrated NVIDIA card. " +
            "NVIDIA Laptops are not supported because their NVIDIA drivers do not contain Digital ColerEye! " +
            "You are missing the Digital ColerEye option in your NVIDIA Control Panel. ColerEye can not run on your system.";
        public const string NvapiErrorSystypeUnknown = "ColerEye failed to initialize! Graphics card system type (Desktop / Laptop) is unknown!";
        public const string GuideLink = "https://github.com/K-M19/ColerEye/blob/main/ErrorFix.md";
        ...
        public NvidiaDynamicVibranceProxy(List<ApplicationSetting> savedApplicationSettings, Dictionary<string, Tuple<ResolutionModeWrapper, List<ResolutionModeWrapper>>> currentWindowsResolutionSettings)
        {
            ...
            catch (Exception ex)
            {
                ...
                DialogResult result = MessageBox.Show(NvidiaDynamicVibranceProxy.NvapiErrorInitFailed, "ColerEye Error", 
        ...
        private void InitializeProxy()
        {
            ...
            foreach (int gpuHandle in gpuHandles)
            {
                if(gpuHandle != 0)
                {
                    ...
                    {
                        MessageBox.Show(NvidiaDynamicVibranceProxy.NvapiErrorSystypeUnknown, "ColerEye Error", 
