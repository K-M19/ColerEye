...
namespace vibrance.GUI.common
{
    public partial class VibranceGUI : Form
    {
        ...
        private const string AppName = "ColerEye";
        private const string TwitterLink = "https://Github.com/K-M19";
        ...
        {
            using (StreamWriter w = File.AppendText(Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "ColerEye.log")))
            {
                w.Write("\r\nLog Entry : ");
        ...
        {
            using (StreamWriter w = File.AppendText("ColerEye_log.txt"))
            {
                w.Write("\r\nLog Entry : ");
                w.WriteLine("{0} {1}", DateTime.Now.ToLongTimeString(),
                    DateTime.Now.ToLongDateString());
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            string folderPath = System.IO.Path.Combine(appDataPath, "ColerEye");
