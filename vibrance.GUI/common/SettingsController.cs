...
namespace vibrance.GUI.common
{
    ...
    class SettingsController : ISettingsController
    {
        ...
        private string _fileName = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData).ToString() + "\\ColerEye\\ColerEye.ini";
        private string _fileNameApplicationSettings = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData).ToString() + "\\ColerEye\\applicationData.xml";
